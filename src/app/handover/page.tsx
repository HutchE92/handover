                  ...
                  <div className="p-3 bg-gray-50">
                    <div className="space-y-2">
                      ...
                      {getActiveTasks(patient.id).length > 0 && (
                        <Link
                          href={`/patients/${patient.id}`}
                          onClick={() => sessionStorage.setItem('expandActiveTasks', patient.id)}
                          className="mt-2 w-full flex items-center gap-1 px-2 py-1 bg-indigo-100 text-indigo-800 border border-indigo-300 rounded text-xs font-medium hover:bg-indigo-200 transition-colors print:hidden"
                        >
                      ...
                      {getPendingOohEntry(patient.id) && (
                        <button
                          ...
                          className="mt-2 w-full flex items-center gap-1 px-2 py-1 bg-purple-100 text-purple-800 border border-purple-300 rounded text-xs font-medium hover:bg-purple-200 transition-colors print:hidden"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
